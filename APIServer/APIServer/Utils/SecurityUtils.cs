...
public static class SecurityUtils
{
    ...
    /// 반환값: (성공 여부, 해싱된 비밀번호)
    /// </summary>
    public static (bool , string) HashPassword(string? password, string? salt)
    {
    ...
    /// </summary>
    public static bool VerifyPassword(string storedHash, string storedSalt, string inputPassword)
    {
