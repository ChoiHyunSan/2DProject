...
| 컬럼명 | 타입 | 제약조건 | 설명 |
|---|---|---|---|
| redis_stream_id | VARCHAR(32) | PRIMARY KEY | Redis 스트림 ID |
| email | VARCHAR(255) | NOT NULL | 송신자 이메일 |
| message | VARCHAR(1000) | NOT NULL | 메시지 본문 |
| send_at_utc | DATETIME(6) | NOT NULL | 전송 시간 |
